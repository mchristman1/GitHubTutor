...
class SetupForMac extends StatelessWidget {
  @override
  ...
  Future quizPressed(context) async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => SetupMacQuizStatefulWidget())
    );
  }
  ...
  final Text introductionText = Text(
    """
    This lesson covers setup for Mac users. 
    If you are using a Windows computer, please click the back button and then select “Setup for Windows.” 
    This lesson will walk you through how to get setup for Git commands through terminal and will also show you how to generate SSH keys for your account. 
  ...
  final Text objectiveText = Text(
    ...
    2)	The student will have installed Git on their computer for use with the Mac terminal.
    """,
    style: bodyStyle,
  );
  ...
  final Text step2Text = Text(
    """
    To begin, open the terminal on your computer and enter the following command:\n
    \$ ssh-keygen -t rsa -b 4096 -C “your email address”\n
    Be sure you enter the same email associated with your GitHub account in the quotes ad press enter. 
    This command generates a new SSH key using the email entered as a label. 
    After some processing, you will be presented with the prompt:\n
    > Enter a file in which to save the key (/Users/username/.ssh/id_rsa):\n 
  ...
  final Text step1Text = Text(
    """
    Navigate to https://git-scm.com/downloads and select “Mac OS X download”.\n 
    ...
    Just follow the setup steps presented by the application to install Git. 
    """,
    style: bodyStyle
  );
  ...
  final Text step3Text = Text(
    """
    Now that you have generated an SSH key, you need to add it to the SSH-Agent. The SSH-Agent is just a helper program that keeps track of the user’s keys and passphrases and allows a user to log into external servers without needing to enter their passphrase every time.\n
    ...
    visit https://help.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent#adding-your-ssh-key-to-the-ssh-agent 
  ...
  final List<Text> step4Text = [
    ...
    Text(
      ...
      In the Title box, enter a name specific to the key (such as “My Mac’s Key.” 
      In the Key box, paste the key you copied from the terminal command earlier and then press the button “Add SSH Key.” 
