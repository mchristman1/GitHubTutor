...
class SetupForMac extends StatelessWidget {
  ...
  final RichText introductionText = RichText(
    ...
    text: TextSpan(
      ...
      children: [
        ...
        TextSpan(
          text: ' computer, please click the back button and then select ',
        ),
        TextSpan(
          text: 'Setup for Windows', style: TextStyle(fontStyle: FontStyle.italic),
        ),
        TextSpan(
          text: '. This lesson will walk you through how to get setup for Git commands '
              'through terminal and will also show you how to generate SSH '
  ...
  final RichText objectiveText = RichText(
    ...
    text: TextSpan(
      ...
      children: [
        ...
        TextSpan(
          text: '2)	The student will have installed Git on their computer for use with the Mac terminal.'
        )
      ],
    ),
  );
  ...
  final RichText step2Text = RichText(
    ...
    text: TextSpan(
      ...
      children: [
        TextSpan(
          text: 'To begin, open the terminal on your computer and enter the following command:\n\n'
        ),
        TextSpan(
        ...
        TextSpan(
            text: '> Enter a file in which to save the key (/Users/username/.ssh/id_rsa): ',
          style: TextStyle(backgroundColor: Color.fromRGBO(215, 215, 215, 1)),
        ),
        TextSpan(
      ...
      children: [
        ...
        TextSpan(
          text: '. This will either begin the download automatically or take you '
              ...
              'steps presented by the application to install Git.'
        )
      ]
    )
  );
    ...
    RichText(
      ...
      text: TextSpan(
        ...
        children: [
          ...
          TextSpan(
            text: ' box, enter a name specific to the key (such as “My Mac’s Key.” In the '
          ),
          TextSpan(
            text: 'Key',
            style: TextStyle(fontStyle: FontStyle.italic)
          ...
          TextSpan(
            text: ' box, paste the key you copied from the terminal command earlier '
