  ...
  final RichText introText = RichText(
    ...
    text: TextSpan(
      ...
      children: [
        ...
        TextSpan(
          text: ' users. If you are a Windows user, please press the back button and select '
        ),
        TextSpan(
          text: 'Commands for Windows',
  ...
  final List<RichText> ex3Text = [
    ...
    RichText(
      ...
      text: TextSpan(
        ...
        children: [
          TextSpan(
            text: 'Now, pull up Terminal and type the following commands:\n\n'
          ),
          TextSpan(
  ...
  final RichText ex4Text = RichText(
    ...
    text: TextSpan(
      ...
      children: [
        ...
        TextSpan(
          text: ' . To do so, enter the following in Terminal:\n\n'
        ),
        TextSpan(
      ...
      children: [
        ...
        TextSpan(
          text: ' button. From here, click the clipboard to copy the SSH link.\n\n'
              ...
              'to download the project to (ex: Desktop) and enter the following in Terminal:\n\n'
        ),
        TextSpan(
