...
class MacCommands extends StatelessWidget {
  ...
  Future goToQuiz(context) async {
    Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => MacCommandsQStatefulWidget())
    );
  }
  ...
  final Text introText = Text(
    """
    This lesson is intended for Mac users. If you are a Windows user, please press the back button and then select “Commands for Windows.” 
  ...
  final Text objText = Text(
    """
    1)	The student will be able to create a repository via terminal.\n
    2)	The student will be able to create commits through the terminal.\n
    3)	The student will be able to pull files with terminal.\n
    4)	The student will be able to branch with terminal.\n
    5)	The student will be able to clone with terminal.
    """,
    style: bodyStyle,
  );
  ...
  final Text ex1Text = Text(
    ...
    Once that is done, open the terminal and navigate to the folder you just created.\n
    ...
    Note, you have not yet linked folder to the remote repository you created on GitHub; that will be done later in the lesson.
    """,
    style: bodyStyle,
  );
  ...
  final Text ex2Text = Text(
    """
    Enter the command below to add the text file in the directory to the repository:\n
    \$ git add .\n
  ...
  final List<Text> ex3Text = [
    ...
    Text(
      """
      Now, pull up Terminal and type the following commands:\n
      ...
      The second command verifies the URL as your own. 
      Note: you can also do this by using the https link, but since you set up the SSH key in an earlier lesson, why not use it. 
  ...
  final Text ex4Text = Text(
    """
    Now it is time to add the file you created to GitHub, this is known as a push. 
  ...
  final List<Text> ex5Text = [
    Text(
      ...
      Let’s get started by creating a new branch. Open Terminal and enter the command below:\n
  ...
  final Text ex6Text = Text(
    ...
    To clone the master branch enter the following in Terminal:\n
  ...
  final Text ex7Text = Text(
    """
    Now it is time to talk about the concept of pulling. 
    Pulling is similar to cloning, except when you pull, you typically already have the repository and need to get the latest updates. 
    ...
    Now, push directly to the master branch by entering the following in Terminal:\n
    \$ git push\n
    This will push the changes to the master branch. 
    When you don’t specify a branch, your changes will be pushed to the branch you are currently on.\n
